...
function Transactions() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card padding="none">
        <div className="border-b border-border p-4"><SearchInput aria-label="Search transactions" className="max-w-md" onChange={(event) => setSearch(event.target.value)} placeholder="Search user, type or reference" value={search} /></div>

...
class AppErrorBoundary extends Component {
  constructor(props) {
    super(props)
    this.state = { hasError: false, diagnosticId: '' }
  }

  static getDerivedStateFromError() {
    const diagnosticId = globalThis.crypto?.randomUUID?.().slice(0, 6).toUpperCase() || 'RELOAD'
